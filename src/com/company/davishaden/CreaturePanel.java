...
public class CreaturePanel extends JPanel {
    ...
    private void playSound(Clip c){c.stop();c.setFramePosition(0);c.start();}
    ...
    private class LineListener implements MouseListener,MouseMotionListener {
        ...
        //Starts the timer
        public void mouseDragged(MouseEvent e) {timer.start();}

        //Starts the timer and repaints in order to move the mouse picture.
        public void mouseMoved(MouseEvent e) {timer.start(); repaint();}
